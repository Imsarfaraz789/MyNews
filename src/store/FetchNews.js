...
export const fetchNews = createAsyncThunk('fetchNews', async () => {
    try {
        const response = await fetch(`https://newsapi.org/v2/everything?q=tesla&from=2024-10-01&to=2024-10-05&sortBy=popularity&apiKey=6d151f084bc84a288694b50201fd8bd9&language=en`);
