...
export const fetchNews = createAsyncThunk('fetchNews', async () => {
    try {
        const response = await fetch(`https://newsapi.org/v2/everything?q=all&from=2024-10-01&to=2024-10-05&sortBy=popularity&apiKey=510343443720439a8a47dac206eb600f&language=en`);
        if (!response.ok) {
